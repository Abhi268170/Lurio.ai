                ...
                <div className="max-w-6xl w-full grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="hidden lg:block animate-in fade-in slide-in-from-left-8 duration-1000">
                        ...
                        <div className="mt-8 text-center lg:text-left">
                            <h2 className="text-3xl font-display font-bold text-navy-dark dark:text-white mb-4">Elevate Your Learning</h2>
                            <p className="text-lg text-gray-500 dark:text-gray-400 max-w-md">Experience a new way of mastering subjects with AI-driven personalized curriculum design.</p>
                        </div>
                    </div>
                    ...
                    <div className="w-full max-w-md mx-auto">
                        <div className="text-center mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <h1 className="font-display text-4xl font-bold text-navy-dark dark:text-white mb-2">Welcome Back</h1>
